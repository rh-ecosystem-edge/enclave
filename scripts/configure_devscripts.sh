...
# - Using short suffix '-b' to stay within 15-char bridge name limit
export PROVISIONING_NETWORK="${ENCLAVE_BMC_NETWORK}"
export PROVISIONING_NETWORK_NAME="${ENCLAVE_CLUSTER_NAME}-b"
...
# - Using short suffix '-c' to stay within 15-char bridge name limit
export EXTERNAL_SUBNET_V4="${ENCLAVE_CLUSTER_NETWORK}"
export BAREMETAL_NETWORK_NAME="${ENCLAVE_CLUSTER_NAME}-c"
